package com.example.hmv3.tasks;
...
public class TaskListContent {
    ...
    public static class Task implements Parcelable {
        ...
        public Task(String id, String title, String details) {
            ...
            this.current_sound = current_sound;
            this.imageIndex = 0;

        }

        public Task(String id, String title, String details, String picPath,String phone, String birthday, String current_sound, Integer imageIndex) {
            this.id = id;
            this.title = title;
            this.details = details;
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(current_sound);
            if (imageIndex == null) {
